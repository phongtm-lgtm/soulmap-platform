...
export default function ChatBackground() {
  return (
    <div className="pointer-events-none fixed inset-0 z-0" aria-hidden="true">
      ...
      />
      <span className="absolute left-[18%] top-[22%] h-1 w-1 rounded-full bg-[#B68A2F]/25 animate-float-slow" />
      <span className="absolute left-[68%] top-[14%] h-1.5 w-1.5 rounded-full bg-[#24533E]/12 animate-float" />
      <span className="absolute left-[82%] top-[62%] h-1 w-1 rounded-full bg-[#B68A2F]/20 animate-drift" />
